defmodule VispanaWeb.AppPackageLive.Index do
  ...
  def mount(params, _session, socket) do
    ...
    {:ok, socket |> assign(:config_host, config_host)}
  end
  ...
  defp apply_action(socket, :apppackage, _params) do
    socket
    |> assign(:page_title, "Vispana - Application Package Overview")
    |> assign(:node, nil)
  end
